...
class LocationAdapter(private val locations: List<Location>) :
    ...
    class ItemViewHolder(val itemBinding: ItemLocationBinding) : RecyclerView.ViewHolder(itemBinding.root) {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.itemBinding.locationItemNameText.text = item.identifier
